      ...
      <div className='grid grid-cols-1 sm:grid-cols-12'>
        <div className='col-span-7 place-self-center text-center sm:text-left'>
          ...
          <div className='flex'> {/* Create a flex container */}
            <button className='flex-1 px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-500 via-purple500 to-green-500 hover:bg-slate-400 text-white'>Hire Me</button>
            <button className='flex-1 px-6 py-3 w-full sm:w-fit  rounded-full bg-transparent hover:bg-slate-800 text-white border border-white'>Download CV</button>
          </div>
        </div>
